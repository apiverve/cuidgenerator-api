...
// Request contains the parameters for the Cuid Generator API.
//
// Parameters:
...
// ResponseData contains the data returned by the Cuid Generator API.
type ResponseData struct {
	Cuids []string `json:"cuids"`
	Count int `json:"count"`
	Format string `json:"format"`
	CollisionResistant bool `json:"collision_resistant"`
