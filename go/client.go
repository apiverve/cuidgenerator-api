// Package cuidgenerator provides a Go client for the Cuid Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/cuidgenerator?utm_source=go&utm_medium=readme
package cuidgenerator
...
const (
	baseURL        = "https://api.apiverve.com/v1/cuidgenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Cuid Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Cuid Generator API client.
...
// Execute makes a request to the Cuid Generator API with typed parameters.
//
...
//   - count: integer - Number of Cuids to generate [min: 1, max: 100]
