...
```gradle
dependencies {
    implementation 'com.github.apiverve:cuidgenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.cuidgenerator.CuidGeneratorAPIClient;
import com.apiverve.cuidgenerator.APIResponse;
import com.apiverve.cuidgenerator.APIException;

// Initialize the client
CuidGeneratorAPIClient client = new CuidGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/cuidgenerator](https://docs.apiverve.com/ref/cuidgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/cuidgenerator](https://docs.apiverve.com/ref/cuidgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/cuidgenerator-api/issues)
