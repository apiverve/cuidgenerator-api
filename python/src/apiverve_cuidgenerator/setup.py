...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/cuidgenerator',
        'Source': 'https://github.com/apiverve/cuidgenerator-api',
        'Bug Tracker': 'https://github.com/apiverve/cuidgenerator-api/issues'
    },
    classifiers=[
