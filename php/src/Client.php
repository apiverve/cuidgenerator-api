...
namespace APIVerve\Cuidgenerator;
...
/**
 * Client for the Cuid Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/cuidgenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/cuidgenerator';
    ...
    private const VALIDATION_RULES = [
        'count' => ['type' => 'integer', 'required' => false, 'min' => 1, 'max' => 100]
    ];
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CuidgeneratorClient] {$message}\n";
        }
    }
}
